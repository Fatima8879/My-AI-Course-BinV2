...
#panda, numpy use nhi kia kiu k zaroorat nhi thi ya ak simple example ha
X, y = make_regression(n_samples=100,
                        #jo random data generate kr k day de3ta ha 
                       n_features=10,
                       n_informative=5,
                       n_targets=1,
                       random_state=42)
...
#takay result improve ho saky
gbr.fit(X_train, y_train)
y_pred1 = gbr.predict(X_test)
print("Gradient Boosting - R2: ",        # accuracy measure ho rahi ha
